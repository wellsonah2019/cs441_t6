...
Input:
    ruleIP: contains an ip address of type string
    dataPacketIP: contains an ip address of type string
Return:
...
Input:
    rulePrt: contains port of type int
    dataPacketPrt: contains port of type int
Return:
